...
#include "Engine.h"
    ...
    // This function is just a factory that creates a URootMovement instance.
URootMovement* URootMovement::RootMovement(
    ...
    bool bEnableGravity)
{
    ...
    URootMovement* Node = NewObject<URootMovement>();
    ...
    if (const UWorld* World = GetWorld())
    {
        ...
        if (CharacterMovement) {
            ...
            TimerManager.SetTimer(
                OngoingDelay,
                FTimerDelegate::CreateLambda([WeakThis = TWeakObjectPtr<URootMovement>(this)]()
                    {
